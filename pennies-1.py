...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 12 10:13:54 2019
...
environment_matrix_q = [[1,0],
                      [0,1]] # Player 1 cooperates, player 2 defects

environment_matrix_s = [[0,1],
                      [1,0]]
...
for _ in range(1000):
    # get starting place-
       ...
       # opponent_future_action =  opponent_action
        ...
        q_matrix[prev_own_action][prev_opponent_action][own_action] = q_matrix[prev_own_action][prev_opponent_action][own_action] + learning_rate * (environment_matrix_q[own_action][opponent_action] + 
        ...
        sarsa_matrix[prev_opponent_action][prev_own_action][opponent_action] = sarsa_matrix[prev_opponent_action][prev_own_action][opponent_action] + learning_rate * (environment_matrix_s[opponent_action][own_action] + 
